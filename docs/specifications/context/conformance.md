...
| `ContextRequest.history_tokens` / `assembled_tokens_last_turn` | MUST (kernel-side) | kernel-computed on every firing, not just compactor-directed ones — [`data-types.md#compactor-timing-signals`](data-types.md#compactor-timing-signals) |
